...
1) (Default, with `out = matches`) Boolean matrix indicating which ranges/sequences contain which motifs, stored as "motif_matches" in assays slot of SummarizedExperiment object. The `motif_matches` methods can be used to extract the boolean matrix.
